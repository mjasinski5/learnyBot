...
async function register(senderId) {
  try {
    ...
    await senderService.sendTextMessage(senderId,  'Oh.. I see you are here by the first time my Friend! Lets take a look at Categories!');
    await senderService.sendCategory(senderId);
  }
  catch(e) {
